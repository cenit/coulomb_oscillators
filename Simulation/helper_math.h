...
constexpr float fminf(float a, float b)
{
    return a < b ? a : b;
}

constexpr float fmaxf(float a, float b)
{
    return a > b ? a : b;
}

constexpr double fmin(double a, double b)
{
	return a < b ? a : b;
}

constexpr double fmax(double a, double b)
{
	return a > b ? a : b;
}
...
constexpr __host__ __device__ void operator+=(float2 &a, float2 b)
{
    a.x += b.x;
    a.y += b.y;
}
...
constexpr __host__ __device__ void operator+=(float2 &a, float b)
{
    a.x += b;
    a.y += b;
}
...
constexpr __host__ __device__ void operator+=(double2 &a, double2 b)
{
	a.x += b.x;
	a.y += b.y;
}
...
constexpr __host__ __device__ void operator+=(double2 &a, double b)
{
	a.x += b;
	a.y += b;
}
...
constexpr __host__ __device__ void operator+=(int2 &a, int2 b)
{
    a.x += b.x;
    a.y += b.y;
}
...
constexpr __host__ __device__ void operator+=(int2 &a, int b)
{
    a.x += b;
    a.y += b;
}
...
constexpr __host__ __device__ void operator+=(uint2 &a, uint2 b)
{
    a.x += b.x;
    a.y += b.y;
}
...
constexpr __host__ __device__ void operator+=(uint2 &a, uint b)
{
    a.x += b;
    a.y += b;
}
...
constexpr __host__ __device__ void operator+=(float3 &a, float3 b)
{
    a.x += b.x;
    a.y += b.y;
    a.z += b.z;
...
constexpr __host__ __device__ void operator+=(float3 &a, float b)
{
    a.x += b;
    a.y += b;
    a.z += b;
...
constexpr __host__ __device__ void operator+=(double3 &a, double b)
{
	a.x += b;
	a.y += b;
	a.z += b;
...
constexpr __host__ __device__ void operator+=(int3 &a, int3 b)
{
    a.x += b.x;
    a.y += b.y;
    a.z += b.z;
...
constexpr __host__ __device__ void operator+=(int3 &a, int b)
{
    a.x += b;
    a.y += b;
    a.z += b;
...
constexpr __host__ __device__ void operator+=(uint3 &a, uint3 b)
{
    a.x += b.x;
    a.y += b.y;
    a.z += b.z;
...
constexpr __host__ __device__ void operator+=(uint3 &a, uint b)
{
    a.x += b;
    a.y += b;
    a.z += b;
...
constexpr __host__ __device__ void operator+=(float4 &a, float4 b)
{
    a.x += b.x;
    a.y += b.y;
    a.z += b.z;
...
constexpr __host__ __device__ void operator+=(float4 &a, float b)
{
    a.x += b;
    a.y += b;
    a.z += b;
...
constexpr __host__ __device__ void operator+=(double4 &a, double4 b)
{
	a.x += b.x;
	a.y += b.y;
	a.z += b.z;
...
constexpr __host__ __device__ void operator+=(double4 &a, double b)
{
	a.x += b;
	a.y += b;
	a.z += b;
...
constexpr __host__ __device__ void operator+=(int4 &a, int4 b)
{
    a.x += b.x;
    a.y += b.y;
    a.z += b.z;
...
constexpr __host__ __device__ void operator+=(int4 &a, int b)
{
    a.x += b;
    a.y += b;
    a.z += b;
...
constexpr __host__ __device__ void operator+=(uint4 &a, uint4 b)
{
    a.x += b.x;
    a.y += b.y;
    a.z += b.z;
...
constexpr __host__ __device__ void operator+=(uint4 &a, uint b)
{
    a.x += b;
    a.y += b;
    a.z += b;
...
constexpr __host__ __device__ void operator-=(double3 &a, double3 b)
{
	a.x -= b.x;
	a.y -= b.y;
	a.z -= b.z;
